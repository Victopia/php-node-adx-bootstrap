...
else{angular.forEach(obj,function(value,property){if(!/^\$/.test(property)){if(namespace){formKey=namespace+'['+property+']';}else{formKey=property;}
objectToFormData(value,formData,formKey);}});for(var property in obj){}}
