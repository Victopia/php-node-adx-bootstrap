...
angular.module("schemaForm").run(function($templateCache) {$templateCache.put("directives/decorators/bootstrap/colorpicker/colorpicker.html","<div class=\"form-group\" ng-class=\"{\'has-error\': hasError()}\">\n  <label class=\"control-label\" ng-show=\"showTitle()\">{{form.title}}</label>\n  <div ng-init=\"defaultSpectrumOptions = {\n                  showInput: true,\n                  showAlpha: true,\n                  allowEmpty: true,\n                  showPalette: true,\n                  preferredFormat: form.colorFormat || \'rgb\',\n                  palette: [[\'#fce94f\', \'#fcaf3e\', \'#e9b96e\'],\n                  [\'#8ae234\', \'#729fcf\', \'#ad7fa8\'],\n                  [\'#ef2929\', \'#888a85\', \'#deface\']]\n                }\">\n    <div spectrum\n      sf-field-model=\"replaceAll\"\n      ng-model=\"$$value$$\"\n      format=\"form.colorFormat || \'rgb\'\"\n      style=\"background-color: white\"\n      type=\"color\"\n      schema-validate=\"form\"\n      options=\"form.spectrumOptions || defaultSpectrumOptions\"></div>\n</div>\n  <span class=\"help-block\">{{ (hasError() && errorMessage(schemaError())) || form.description}}</span>\n</div>\n");});
